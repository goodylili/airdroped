...
func NewAirdrop(rpcURL, privateKeyHex, tokenAddressHex string) (*Airdrop, error) {
	...
	token, err := evm.NewERC20(tokenAddress, client)
	if err != nil {
...
func ConvertToTokenUnits(token ERC20, amount float64) (*big.Int, error) {
...
func MustConvertToTokenUnits(token ERC20, amount float64) *big.Int {
